// Main JavaScript for MyViolinRep
...
function setupAnimations() {
    ...
    document.querySelectorAll('.card, .piece-card, .performer-card').forEach(el => {
        observer.observe(el);
    });
...
function setupInteractiveElements() {
    // Card hover effects
    document.querySelectorAll('.card, .piece-card').forEach(card => {
...
document.addEventListener('keydown', function(e) {
    ...
    if (e.key === 'Escape') {
        ...
        const activeDropdowns = document.querySelectorAll('.user-dropdown.active');
...
function improveAccessibility() {
    ...
    document.querySelectorAll('a, button, input, select, textarea').forEach(element => {
        element.addEventListener('focus', function() {
            this.style.outline = '2px solid #8B0000';
